...
//*************************************Update the manager role for user********************************
        [HttpPost]
    ...
    ManageUserRoles(List<UserRolesViewModel> model, string userId)
            ...
            else
            {
                ...
                catch(DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{role.Name} role cannot be deleted as there are users " +
                        $"in this role. If you want to delete this role,please remove the user from " +
        ...
        public async Task<IActionResult> EditRole(EditRoleViewModel model)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Roles with Id = {model.Id} cannot be found";
                return View("NotFound");
            }
            else
            {
